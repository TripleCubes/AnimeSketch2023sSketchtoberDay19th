...
func rnd_pos_x() -> Vector2:
	return Vector2(randf_range(10, Consts.WINDOW_WH.x - 10), Consts.WINDOW_H)
...
const RND_DIR_UP_ROTATION_RANGE: float = deg_to_rad(20)
...
func out_of_window(pos: Vector2) -> bool:
	return pos.x < -10 or pos.y < -10 or pos.x > Consts.WINDOW_W + 10 or pos.y > Consts.WINDOW_H + 10
